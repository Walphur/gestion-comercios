# Mensajes cortos para mandar por privado
...
No incluye facturación AFIP completa (está en desarrollo).

¿Tenés Windows 10 u 11 en la PC?
```

---

## Después de cerrar venta (enviar clave)
...
3) Abrís la app → pegás la clave → queda en esa PC sola.

Antes de que venza te escribo o me escribís para renovar el mes.

Cualquier duda: mandame captura por acá.
```
