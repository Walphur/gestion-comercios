use crate::license::{
    ...
    push_owner_portal_snapshot, push_workshop_portal_snapshot, recover_admin_pin,
...
#[tauri::command]
pub fn license_recover_admin_pin(license_key: String, new_pin: String) -> Result<(), String> {
    recover_admin_pin(license_key, new_pin)
}
