    ...
    pub(crate) async fn connect<R: Runtime>(
            ...
            .0
        {
            ...
            "sqlite" => {
                ...
                // Una sola conexión: BEGIN/COMMIT vía execute() del guest JS deben
                // reusar el mismo handle. Con el pool default (10) cada statement
                // puede ir a otra conexión → TX huérfanas y "database is locked".
